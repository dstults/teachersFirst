...
public class Opening {
	...
	public Opening(int startYear, int startMonth, int startDay, int startHour, int startMinute, int endYear,
			int endMonth, int endDay, int endHour, int endMinute, int teacherID, String teacherName) {
	...
	public Appointment newAppointment(Date startDate, int duration, int studentID) {
		Appointment newAppointment = new Appointment(startDate, addMinutes(startDate, duration), studentID,
				this.teacherID);
